...
class NiceItemAmount(BaseModel):
    item: Optional[NiceItem] = None
    itemId: int = -1  # use itemId instead item
    amount: int
...
class NiceLore(BaseModel):
    ...
    comments: list[NiceLoreComment] = []  # add default
    voices: list[NiceVoiceGroup] = []  # add default
